<div class="card" id="card_campos_extras">
  <div class="card-header h4 card-header-sticky">
    {{ $pessoa->codpes }} - <i>{{ $pessoa->replicado('nome') }}</i>
    | <a href="{{ url()->current() }}#card_replicado">Dados USP <i class="fas fa-caret-up"></i></a>
    | <b>Campos Extras</b>
    
    <a href="{{ route('pessoas.edit', $pessoa->codpes) }}" class="btn btn-sm btn-primary">
