        ...
        <div class="form-row">
            ...
            <div class="col input-group mb-3">
                <input type="text" class="form-control" aria-label="Nome" aria-describedby="inputGroup-sizing-sm"
                    id="codpes" name="nompes" value="{{old('nompes', request()->nompes)}}" autocomplete="off" placeholder="ou Nome">
            </div>
            <div class="col input-group mb-3">
            ...
            <div class="col input-group mb-3">
                <select class="select2-setor" name="codset[]" multiple="multiple">
                    @foreach (Uspdev\Replicado\Estrutura::listarSetores() as $setor)
                        ...
                        @endphp
                        <option {{$setorSelecionado}} value="{{$setor['codset']}}">{{$setor['nomabvset']}} - {{$setor['nomset']}}</option>
                    @endforeach
                </select>   
            </div>
            <div class="col input-group mb-3">
                <div class="form-check">
                    ...
                    @endphp
                    <input class="form-check-input" type="checkbox" {{$docente_aposentado}} value="0" id="docente_aposentado" name="docente_aposentado">
