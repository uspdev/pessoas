        ...
        <div class="row">
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="sexo" name="sexo" value="{{old('sexo',$pessoa->sexo)}}">
                </div>
            </div>
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nacionalidade" name="nacionalidade" value="{{old('nacionalidade',$pessoa->nacionalidade)}}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mae" name="mae" value="{{old('mae',$pessoa->mae)}}">
                </div>
            </div>
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pai" name="pai" value="{{old('pai',$pessoa->pai)}}">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control rg" id="rg" name="rg" value="{{old('rg',$pessoa->rg)}}">
                </div>
            </div>
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pis" name="pis" value="{{old('pis',$pessoa->pis)}}">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="passaporte" name="passaporte" value="{{old('passaporte',$pessoa->passaporte)}}">
                </div>
            </div>
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="rne" name="rne" value="{{old('rne',$pessoa->rne)}}">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pais" name="pais" value="{{old('pais',$pessoa->pais)}}">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="emails" name="emails" value="{{old('emails',$pessoa->emails)}}">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="banco" name="banco" value="{{old('banco',$pessoa->banco)}}">
                </div>
            </div>
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control agencia" id="agencia" name="agencia" value="{{old('agencia',$pessoa->agencia)}}">
                </div>
            </div>
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="conta_corrente" name="conta_corrente" value="{{old('conta_corrente',$pessoa->conta_corrente)}}">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="sigla_universidade" name="sigla_universidade" value="{{old('sigla_universidade',$pessoa->sigla_universidade)}}">
                </div>
            </div>
        </div>
